...
var EvolutionTab = (function () {
    function EvolutionTab(parent, t) {
        ...
        li.append('input').attr('id', 'radio' + this._i).attr('name', 'tab').attr('type', 'radio');
        li.append('label').attr('for', 'radio' + this._i).text(t('Population') + ' ' + this._i);
        li.append('div').attr('class', 'tab-content');
        var self = this;
        ...
        this._canvas = tab_content.append('div').attr('class', 'field');
        this.update_field();
...
var BreedingTab = (function () {
    function BreedingTab(parent, t) {
        ...
        li.append('input').attr('id', 'radio' + num).attr('name', 'tab').attr('type', 'radio');
        li.append('label').attr('for', 'radio' + num).text(t('Breeding experiment'));
        li.append('div').attr('class', 'tab-content').text('UNDER CONSTRUCTION');
    }
    return BreedingTab;
})();
function main(t) {
    var params = [
        ...
        [t('Population') + ' 1 ' + t('Oasis'), 'oasis1', 0, 2, 1, 0],
        [t('Population') + ' 2 ' + t('Oasis'), 'oasis2', 0, 2, 1, 2]
    ];
    var languages = [
    ...
    }).selectAll('option').data(languages).enter().append('option').attr('value', function (d) {
        return d.value;
